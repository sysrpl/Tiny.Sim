...
{ TShape }
  ...
  private
    ...
    function GetCategory: TBitmask;
    procedure SetCategory(Value: TBitmask);
  ...
  public
    ...
    property Category: TBitmask read GetCategory write SetCategory;
...
function TShape.GetCategory: TBitmask;
begin
  Result := Ref.filter.categories;
end;

procedure TShape.SetCategory(Value: TBitmask);
begin
