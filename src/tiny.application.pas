...
begin
  ...
  begin
    Item.flags := 0;
    if Buttons[I].Contains('exit', true) or Buttons[I].Contains('quit', True) or
      Buttons[I].Contains('close', True) then
      Item.flags := SDL_MESSAGEBOX_BUTTON_ESCAPEKEY_DEFAULT;
    Item.buttonid := I;
