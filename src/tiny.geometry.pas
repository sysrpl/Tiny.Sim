...
{ TVec2 is a two component vector
  ...
  public
    ...
    class operator Implicit(const Value: TVec2): TPointD; inline;
...
class operator TVec2.Implicit(const Value: TPointD): TVec2;
begin
  Result.X := Value.X;
  Result.Y := Value.Y;
end;

class operator TVec2.Implicit(const Value: TVec2): TPointD;
begin
  Result.X := Value.X;
  Result.Y := Value.Y;
end;
